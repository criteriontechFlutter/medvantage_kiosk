...
class ChatPage extends StatefulWidget {
  ...
  ChatPage({super.key, required this.deviceName, required this.deviceAddress});
...
class _ChatPage extends State<ChatPage> {
                                            ...
                                            actions: [
                                              TextButton(
                                                  ...
                                                  onPressed: () {
                                                    ...
                                                    String hName =
                                                        "h${hostpotName.value.text.toString()}";
                                                    String hPassword =
                                                        "p${hotspotPassword.value.text.toString()}";
  ...
  void sendDataTOServer() async {
    String socketurl = "\$${modal.controller.getpatientDetails.socketUrl}";
    String hName = "h${modal.controller.hotSpotNameC.value.text.toString()}";
    String hPassword = "p${modal.controller.passwordC.value.text.toString()}";
