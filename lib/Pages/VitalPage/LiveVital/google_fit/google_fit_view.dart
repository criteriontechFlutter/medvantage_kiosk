...
import 'dart:io';
import 'dart:math';
import 'package:digi_doctor/Pages/VitalPage/LiveVital/google_fit/vitals_moitoring_widget.dart';
        ...
        child: Scaffold(
          appBar: AppBar(
            title: Row(
              ...
              children: [
                Text(Platform.isAndroid ? 'Google Fit' : 'Apple Health'),
                MyButton(
                  height: 35,
                  width: 100,
                  ...
                  title: 'Fetch Data',
                  onPress: () {
                    App().replaceNavigate(context, GoogleFitView());
                  },
                ),
              ],
            ),
