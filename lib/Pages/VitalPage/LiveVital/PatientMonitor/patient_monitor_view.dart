                    ...
                    children: [
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    PatientMonitorVM.getIsMeasureBp && PatientMonitorVM.getDysData.toDouble()!=0.0?
                                                    Lottie.asset('assets/blinker.json',height: 15,width: 15,)
                                                        : CircleAvatar(
                                                        radius: 10,
                                                        backgroundColor:
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  PatientMonitorVM.getNewPRValue
                                                      .toString(),
                                                  style: MyTextTheme()
                                                      .mediumBCB
                                                      .copyWith(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          //   mainAxisAlignment: MainAxisAlignment.end,
                          //   children: [
                          //     Text('Change X-Axis Length ',style: MyTextTheme().mediumWCB,),
                          ...
                          //   mainAxisAlignment: MainAxisAlignment.end,
                          //   children: [
                          //     Text('Change Y-Axis Length ',style: MyTextTheme().mediumWCB,),
                          ...
                          //   print('Setting ');
                          // },
                          // icon: Icon(Icons.settings,color: AppColor.white,size: 30,)),
