class ResultDataModal {
  String? businessStatus;
  Geometry? geometry;
  String? icon;
  String? iconBackgroundColor;
  String? iconMaskBaseUri;
  List<Null>? moreOpeningHours;
  String? name;
  ...
  ResultDataModal.fromJson(Map<String, dynamic> json) {
    ...
    if (json['more_opening_hours'] != null) {
      moreOpeningHours = <Null>[];
      json['more_opening_hours'].forEach((v) {
        moreOpeningHours!.add(v);
      });
    }
    name = json['name'];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.moreOpeningHours != null) {
      data['more_opening_hours'] =
          this.moreOpeningHours!.map((v) => v ).toList();
    }
    data['name'] = this.name;
